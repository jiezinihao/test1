  ...
  <div class="home">
    ...
    <div class="model" v-for="item in model" :key="item.title">
      ...
      <div class="model-slide">
        <div class="model-slide-son"  v-for="item1 in item.books" :key="item1.bookId">
...
methods: {
  getBookHome(){
    this.axios.get(this.defaulturl + "/api/BookHome/GetHome")
    .then((res)=>{
      console.log(res)
...
.home{
  ...
  .model{
    ...
    .model-slide::-webkit-scrollbar { width: 0 !important }
  }
